...
const phases = [
  { n: "01", name: "Explore", title: "Find the right problem to solve", text: "Turn lived experience and market observations into a focused business opportunity worth testing.", focus: ["Idea validation", "Founder readiness", "Market discovery"], resources: "SBA market research, SCORE mentoring, and SBDC discovery support", operations: "Customer discovery, needs validation, and founder readiness" },
  { n: "02", name: "Plan", title: "Build a practical path forward", text: "Clarify the customer, offer, business model, milestones, and decisions that come before launch.", focus: ["Business model", "Mentor support", "Planning tools"], resources: "SCORE planning templates, SBDC advising, and VBOC counseling", operations: "Business model, legal and financial planning, and milestones" },
  { n: "03", name: "Launch", title: "Move from plan to first customer", text: "Choose the essentials, formalize the business, and bring the first version of the offer to market.", focus: ["Business setup", "First offer", "Go-to-market"], resources: "SBA startup guides, VBOC programs, and Texas Veterans Commission support", operations: "Formation, banking, offer design, and the first sale" },
  { n: "04", name: "Operate", title: "Create a business that runs clearly", text: "Connect front-office activity to the systems, people, technology, and routines behind delivery.", focus: ["Core operations", "Technology stack", "Financial rhythm"], resources: "SCORE operations tools, SBDC advising, and ecosystem referrals", operations: "Service delivery, accounting, technology, and operating routines" },
  { n: "05", name: "Grow", title: "Build repeatable momentum", text: "Strengthen acquisition, delivery, partnerships, and capacity without losing control of the operation.", focus: ["Growth channels", "Team capacity", "Capital readiness"], resources: "SBDC growth advising, SURE education, and capital-readiness programs", operations: "Sales, hiring, capital, partnerships, and capacity planning" },
  { n: "06", name: "Optimize", title: "Make the whole system work better", text: "Review results, remove friction, and direct time and resources toward what creates the most value.", focus: ["Performance review", "Process improvement", "Next-stage strategy"], resources: "SCORE mentorship, SBDC reviews, and trusted specialist referrals", operations: "Metrics, process improvement, automation, and next-stage strategy" },
];
...
export default function Home() {
  ...
  return <main>
    ...
    <footer><div><strong>B</strong><span><b>BOSS Libraries™</b><small>Business navigation for owner-operators.</small></span></div><nav><a href="#top">Home</a><a href="#about">About</a><a href="#how">How it works</a><a href="#resources">Resources</a><a href="#connect">Join</a><a href="#newsletter">Newsletter</a></nav><p>© 2026 BOSS Libraries. Pilot experience.</p></footer>
  </main>;
}
